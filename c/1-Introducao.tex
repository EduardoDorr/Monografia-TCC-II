...
\begin{enumerate}[label=\alph*)]
	...
	\item Compreensão a base física e matemática aplicada na modelagem de um sistema;
	\item Simulação e análise do comportamento de um sistema a partir da modelagem do mesmo;
	\item Construção uma maquete didática que simula em pequena escala uma planta real;
	\item Análise dos parâmetros da planta e comparação com o modelo calculado;
	\item Desenvolvimento de um controlador PID discreto em cascata para controle de tensão do material a partir do torque do atuador realimentado pela corrente elétrica do motor;
	\item Análise dos resultados obtidos no controle simulado da planta;
	\item Implementação do controlador desenvolvido em sistema embarcado;
	\item Análise dos resultados obtidos no controle implementado da planta, comparando com os resultados simulados.
\end{enumerate}
